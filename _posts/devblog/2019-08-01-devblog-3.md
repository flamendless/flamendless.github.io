...
Second, I need to learn how to parse the PNG. Extract the PNG header and its actual data. I have found this [simple guide](https://lua-users.org/wiki/PortableNetworkGraphicsParser) about it.
